        ...
        <section className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8 h-full flex items-center">
          <div className="w-full flex flex-col items-center gap-6">
            <AnimatedOnLoad className="text-center" variant="fade-up" durationMs={600}>
              <h1 className="text-4xl sm:text-5xl font-semibold tracking-tight text-gray-900">Reset your password</h1>
              <p className="mt-3 text-neutral-900">We’ll send you a reset link</p>
            </AnimatedOnLoad>
